...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec("sudo", ["bash", "-c", `echo "deb http://packages.ros.org/ros2/ubuntu $(lsb_release -sc) main" > /etc/apt/sources.list.d/ros2-latest.list`]);
            yield exec.exec("sudo", ["apt-get", "update"]);
            ...
            yield exec.exec("sudo", ["pip3", "install", "argcomplete", "colcon-common-extensions", "colcon-mixin", "flake8", "flake8-blind-except", "flake8-builtins", "flake8-class-newline", "flake8-comprehensions", "flake8-deprecated", "flake8-docstrings", "flake8-import-order", "flake8-quotes", "pytest", "pytest-cov", "pytest-repeat", "pytest-rerunfailures", "pytest-runner", "setuptools", "wheel",]);
            // Initializes rosdep
